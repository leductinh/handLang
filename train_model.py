...
image_path = 'data_rgb'
models_path = 'models/saved_model_rgb.hdf5'
rgb = True
imageSize = 224
...
# Khoi tao model
model1 = keras.applications.VGG16(weights='imagenet', include_top=False, input_shape=(imageSize, imageSize, 3))
...
model.save('models/mymodel_rgb.h5')
